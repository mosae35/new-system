...
@section('content')
    ...
    <div class="container ">
        <div class="row">
            ...
            <div class="col-lg-9 auth" style="margin-top: 100px;">
                <div style=" border-radius: 15px;background: #ffffff8f;">
                    ...
                    <div class="panel-heading " style="margin-right: 121px;">
                        {!! Form::open() !!}
                        <a href="{{url('out_store/create')}}"style=" margin-bottom: 10px;" class=" links btn btn-primary">
                            <span>  لوحه اضافه شرائح جديده</span>
                        </a>
                        <span> - </span>
                        <a href="{{url('out_add_sort_b')}}" style=" margin-bottom: 10px;" class =" links btn btn-primary ">
                            <span>لوحه اضافه مسامير جديده</span>
                        </a>
                        <span> - </span>
                        <a href="{{url('out_add_sort_c')}}" style=" margin-bottom: 10px;" class="links btn btn-primary ">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="name" class=" control-label">البحث : </label>
                                <input class="search_a form-control" type="text" name="search"
                                       placeholder="اكتب نوع الشريحه" id="search_a">
                        </div>
                        {!! Form::close() !!}
                        ...
                        <div>
                            ...
                            30px;background: #40a01a24; padding: 10px;border-radius: 5px;">  انواع الشرائح فى الخارج
                            </h4>
                        </div>
                        ...
                        <table class=" msg_a table_process table" >
                            ...
                            @foreach($in_data as $processs)
                                <tr style="color: black;">
                                    ...
                                    <td>
                                        {!! Form::open() !!}
                                        <a href="{{url('out_store/'.$processs->id.'/edit')}}"
                                    ...
                                    <td>
                                        {!! Form::open(['method'=>'DELETE' ,'route'=>['out_store.destroy',$processs->id]]) !!}
            ...
            <div class="col-lg-9 auth" style="margin-bottom: 20px; margin-top: 20px;">
                <div style=" border-radius: 15px;background: #ffffff8f;">
                    <div class="panel-body">
                        {!! Form::open() !!}
                        <div class="form-group">
                            <label for="name" class=" control-label">البحث : </label>
                            <input class="search_b form-control" type="text" name="search" placeholder="اكتب نوع المسمار "
                                   id="search_b">
                        </div>
                        {!! Form::close() !!}
                        ...
                        <div>
                            <h4 class="col-lg-3 text-center col-lg-offset-5 "
                                style="margin-top: 38px;margin-bottom:
                            30px;background: #40a01a24; padding: 10px;border-radius: 5px;">انواع المسامير فى الخارج
                            </h4>
                        </div>
                        <table class=" msg_b table_process table" >
                            ...
                            @foreach($data_b as $processs)
                                <tr style="color: black;">
                                    ...
                                    <td>
                                        {!! Form::open() !!}
                                        <a href="{{url('out_edit/sort_b/'.$processs->id)}}"
            ...
            <div class="col-lg-9 auth">
                <div style=" border-radius: 15px;background: #ffffff8f;">
                        ...
                        <div class="form-group">
                            <label for="name"
                                ...
                                <input class="search_c form-control"
                                       type="text" name="search" placeholder="اكتب نوع المسمار ذات القطر" id="search_c">
                        </div>
                        {!! Form::close() !!}

                        <div>
                            <h4 class="col-lg-4 text-center col-lg-offset-5 "
                                style="margin-top: 38px;margin-bottom:
                            30px;background: #40a01a24; padding: 10px;border-radius: 5px;">انواع المسامير ذات القطر فى الخارج
                            </h4>
                        </div>
                        ...
                        <table class=" msg_c table_process table " >
                            ...
                            @foreach($data_c as $processs)
                                <tr style="color: black;">
                                    ...
                                    <td>
                                        {!! Form::open() !!}
                                        <a href="{{url('out_edit/sort_c/'.$processs->id)}}"
                                           class="btn btn-primary btn-sm">تعديل</a>
                                        {!! Form::close() !!}
                                    </td>
                                    <td>
                                        {!! Form::open(['url'=>['out_remove_sort_c/'.$processs->id],'method'=>'post']) !!}
                                        {!! Form::submit('حذف',['class'=>'btn btn-danger btn-sm ']) !!}
                                        {!! Form::close() !!}
                                    </td>
                                </tr>
                    ...
                    <div class="pagination"> {{$data_c->render()}} </div>
                </div>
            </div>
