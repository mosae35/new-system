            ...
            {!! Form::open(['route'=>'process.store'])!!}
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="name"
                               class=" control-label">اسم الدكتور :</label>
                            {!! Form::text('doctor',null,
                          ['class'=>'form-control','placeholder'=>'الدكتور']) !!}
                    ...
                    <div class="form-group">
                        <label for="password"
                            ...
                            {!! Form::text('type',null,
                           ['class'=>'form-control','placeholder'=>'النوع']) !!}
                        @if ($errors->has('type'))
                            <span class="help-block">
                    ...
                    <div class="form-group">
                        <label  class=" control-label">اسم الفنى  </label>
                            ...
                            ['class'=>'form-control','placeholder'=>'الفنى']) !!}
