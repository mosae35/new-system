                ...
                <div style=" border-radius: 15px;background: #ffffff8f;">
                    <div class="panel-heading ">
                        <div class="col-lg-4 pull-left">
                            <h4>
                                {!! Form::open() !!}
                                <a style="" class=" all_process btn btn-primary"
                                   href="/insert_account">
                        ...
                        <h4>
                            {!! Form::open() !!}
                            <a style="margin-right: auto;" class="all_process btn btn-primary" href="\process\create">
                    ...
                    <div class="panel-body" style="direction: rtl">
                        ...
                        <div>
                            ...
                            30px;background: #40a01a24; padding: 10px;border-radius: 5px;">
                                <span>الادوات الخارجه مع الحاله</span>
                            </h4>
                        </div>
                        ...
                        <!-- Form Name -->
                        <div>
                            <h4 class="col-lg-4 text-center col-lg-offset-4 "
                                style="margin-top: 38px;margin-bottom:
                            30px;background: #40a01a24; padding: 10px;border-radius: 5px;">
                                <span>الادوات المستخدمه مع الحاله</span>
                            </h4>
                        </div>
                        <table class="table_process table " >
                            <tr style="color: white;">
                ...
                <div style=" border-radius: 15px;background: #ffffff8f;">
                    <div class="panel-heading ">
                        <h4 class="text-center"
                            style="background: #40a01a24; padding: 10px;border-radius: 5px;color: black;"> لوحه تسجيل المتبقى من المبلغ</h4>
                    </div>
                    <div class="panel-body" style="direction: rtl">
                        {!! Form::open(['url'=>'process/pay/'.$only_process->id]) !!}

                        <div class="form-group">
                            <label for="name" class=" control-label"> دفع المتبقى من المبلغ: </label>
